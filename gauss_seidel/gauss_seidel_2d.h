#ifndef GAUSS_SEIDEL_2D_H
#define GAUSS_SEIDEL_2D_H
...
public:
    ...
    static void solve_serial(
        std::vector<double>& u,      // 解向量 (N+2)x(N+2)，包含边界
        const std::vector<double>& f, // 右端项 NxN
        int N,                        // 内部网格点数
        double h,                     // 网格间距
        int max_iter,                 // 最大迭代次数
        double tol,                   // 收敛容差
